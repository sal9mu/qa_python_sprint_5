...
class TestRegistration:
    def test_registration_new_user(self, create_driver):
        ...
        registration_link = wait.until(EC.element_to_be_clickable(login_page_locators.registration_link))
        ...
        wait.until(EC.visibility_of_element_located(login_page_locators.login_button))
        element = wait.until(EC.visibility_of_element_located(login_page_locators.login_label))
